...
import { Languages } from "fumadocs-ui/internal/icons";
    ...
    <Navbar>
      ...
      <ul className="flex flex-row items-center ms-auto -me-1.5 lg:hidden">
        ...
        <Menu>
          ...
          >
            <IconChevronDown className="!size-5.5 transition-transform duration-300 group-data-[state=open]:rotate-180" />
          </MenuTrigger>
            ...
            <div className="-ms-1.5 flex flex-row items-center gap-1.5 max-sm:mt-2">
              ...
              {i18n ? (
                <LanguageToggle>
                  <Languages className="size-5" />
                  <LanguageToggleText />
                  <IconChevronDown className="size-3 text-fd-muted-foreground" />
                </LanguageToggle>
              ) : null}
              {themeSwitch.enabled !== false &&
